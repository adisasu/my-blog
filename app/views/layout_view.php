...
<html>
	<head>
		...
		<script src="public/js/init.js"></script>
			...
			<link rel="stylesheet" type="text/css" href="public/css/skel-noscript.css" />
			<link rel="stylesheet" type="text/css"  href="public/css/style.css" />
			<link rel="stylesheet" type="text/css" href="public/css/style-desktop.css" />
	...
	<!-- Header -->
        ...
        <li><a href="#">Register</a></li>
			...
			<div class="container">
				...
				<!-- Logo -->
				<div id="logo">
					<h5><a href="#">Adrian Sasu</a></h5>
					<span class="tag">By adisasu</span>
				</div>
			</div>
		</div>
	...
	<!-- Main -->
		...
		<div id="main">
           ...
           <?php include $pageContent;?>
					<!--<section class="6u">
						<a href="#" class="image full"><img src="public/images/pic01.jpg" alt=""></a>
						<header>
					...
					<section class="6u">
						<a href="#" class="image full"><img src="public/images/pic02.jpg" alt=""></a>
						<header>
							<h2>Mauris vulputate dolor</h2>
						</header>
						<p>In posuere eleifend odio. Quisque semper augue mattis wisi. Maecenas ligula. Pellentesque viverra vulputate enim. Aliquam erat volutpat. Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum.</p>
				...
				<div class="row">
					<section class="6u">
						<a href="#" class="image full"><img src="public/images/pic03.jpg" alt=""></a>
						<header>
							<h2>Mauris vulputate dolor</h2>
						</header>
						<p>In posuere eleifend odio. Quisque semper augue mattis wisi. Maecenas ligula. Pellentesque viverra vulputate enim. Aliquam erat volutpat. Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum.</p>
					...
					<section class="6u">
						<a href="#" class="image full"><img src="public/images/pic04.jpg" alt=""></a>
						<header>
							<h2>Mauris vulputate dolor</h2>
						</header>
						<p>In posuere eleifend odio. Quisque semper augue mattis wisi. Maecenas ligula. Pellentesque viverra vulputate enim. Aliquam erat volutpat. Donec leo, vivamus fermentum nibh in augue praesent a lacus at urna congue rutrum.</p>
